...
public class PageAction implements HttpFilter {
	final Logger log = LoggerFactory.getLogger(PageAction.class);
	...
	public void doFilter(DominoSession domSession, HttpServletRequest request, HttpServletResponse response) throws IOException,ServletException{
		...
		if (actionName.equals("openpage")){
			...
			Resource resource = Resources.getResource(cfg,"page",fileName);
			if (resource==null){
